...
class ProductSearchViewTests(TestCase):
    def setUp(self):
        ...
        self.p1 = Product.objects.create(name="Aspirin", price=10.00, category=self.category)
        self.p2 = Product.objects.create(name="Paracetamol", price=8.00, category=self.category)
        self.p3 = Product.objects.create(name="Ibuprofen", price=12.00, category=self.category)
